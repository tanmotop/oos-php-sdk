...
class RequestCore
{
     ...
     */
    public $request_class = 'Tanmo\OOS\Http\RequestCore';

    /**
     * The default class to use for HTTP Responses (defaults to <ResponseCore>).
     */
    public $response_class = 'Tanmo\OOS\Http\ResponseCore';
...
//		curl_setopt($curl_handle, CURLOPT_CLOSEPOLICY, CURLCLOSEPOLICY_LEAST_RECENTLY_USED);
    ...
    public function process_response($curl_handle = null, $response = null)
    {
        ...
        if (is_resource($curl_handle) || (is_object($curl_handle) && in_array(get_class($curl_handle), ['CurlHandle', 'Swoole\Curl\Handler', 'Swoole\Coroutine\Curl\Handle'], true))) {
