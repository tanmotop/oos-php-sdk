...
use Tanmo\OOS\Core\MimeTypes;
use Tanmo\OOS\Core\OosException;
use Tanmo\OOS\Http\RequestCore;
use Tanmo\OOS\Http\RequestCore_Exception;
use Tanmo\OOS\Http\ResponseCore;
use Tanmo\OOS\Model\CorsConfig;
use Tanmo\OOS\Model\LoggingConfig;
use Tanmo\OOS\Result\AclResult;
use Tanmo\OOS\Result\GetCorsResult;
use Tanmo\OOS\Result\GetPolicyResult;
use Tanmo\OOS\Result\GetLifecycleResult;
use Tanmo\OOS\Result\GetLocationResult;
use Tanmo\OOS\Result\GetLoggingResult;

use Tanmo\OOS\Result\GetAccelerateResult;
use Tanmo\OOS\Result\GetWebsiteResult;
use Tanmo\OOS\Result\HeaderResult;
use Tanmo\OOS\Result\InitiateMultipartUploadResult;
use Tanmo\OOS\Result\ListBucketsResult;
use Tanmo\OOS\Result\ListMultipartUploadResult;
use Tanmo\OOS\Model\ListMultipartUploadInfo;
use Tanmo\OOS\Result\ListObjectsResult;
use Tanmo\OOS\Result\ListPartsResult;
use Tanmo\OOS\Result\PutSetDeleteResult;
use Tanmo\OOS\Result\DeleteObjectsResult;
use Tanmo\OOS\Result\CopyObjectResult;
use Tanmo\OOS\Result\CallbackResult;
use Tanmo\OOS\Result\ExistResult;
use Tanmo\OOS\Result\AppendResult;
use Tanmo\OOS\Result\RegionsResult;
use Tanmo\OOS\Result\CreateAccessKeyResult;
use Tanmo\OOS\Result\ListAccessKeyResult;
use Tanmo\OOS\Result\GetObjectResult;
use Tanmo\OOS\Model\ObjectListInfo;
use Tanmo\OOS\Result\UploadPartResult;
use Tanmo\OOS\Model\BucketListInfo;
use Tanmo\OOS\Model\LifecycleConfig;
use Tanmo\OOS\Model\RefererConfig;
use Tanmo\OOS\Model\WebsiteConfig;
use Tanmo\OOS\Core\OosUtil;
use Tanmo\OOS\Model\ListPartsInfo;

use Tanmo\OOS\Config\DomainConfig;
use Tanmo\OOS\Config\Config;
...
use Tanmo\OOS\Model\CopyPartInfo;

use Tanmo\OOS\Result\CompleteMultipartUploadResult;
use Tanmo\OOS\Model\CompleteMultipartUploadInfo;

use Tanmo\OOS\Result\DeleteUpdateAccessKeyResult;
use Tanmo\OOS\Model\DeleteUpdateAccessKeyInfo;
use Tanmo\OOS\Model\ObjectInfo;

use Tanmo\OOS\Result\HeaderObjectResult;
/**
 * Class OosClient
 *
